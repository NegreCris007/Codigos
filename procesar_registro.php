...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conexion->prepare("SELECT id FROM usuarios WHERE cedula = :cedula");
        ...
        $stmt = $conexion->prepare("INSERT INTO usuarios (cedula, nombre, departamento, password) VALUES (:cedula, :nombre, :departamento, :password)");
